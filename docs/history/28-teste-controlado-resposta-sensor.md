...
A sensibilidade de rotação de 450°/s já integra o receptor compartilhado e permanece em uso. O intervalo mínimo de reconhecimento de 650 ms não foi alterado. O atalho `launchers/macos/Jogar com sensor Wi-Fi.command` abre o jogo completo, prepara a conexão e seleciona a corrida automática.
